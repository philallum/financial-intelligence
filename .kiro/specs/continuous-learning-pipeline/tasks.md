...
- [x] 1. Database schema and shared types
  - [x] 1.1 Create database migration for `prediction_explanations` and `drift_alerts` tables
  ...
  - [x] 1.2 Add `LearningPipelineDiagnostics` type and extend `BatchDiagnosticsPayload`
  ...
  - [x] 1.3 Update ML service dependencies in `ml_service/requirements.txt`
    - Add `shap==0.46.0` and `joblib==1.4.2`
    - _Requirements: 3.1, 12.1_

- [x] 2. Implement Calibration Service and router (Python)
  - [x] 2.1 Implement `ml_service/app/services/calibration.py`
  ...
  - [x] 2.2 Write property tests for Calibration Service
  ...
  - [x] 2.3 Implement `ml_service/app/routers/calibration.py`
  ...
  - [x] 2.4 Register calibration router and startup hook in `ml_service/app/main.py`
    - Import and include calibration router
    - Call `CalibrationService.get_instance().load_if_available()` in lifespan startup
    - _Requirements: 12.2, 12.3_

  - [x] 2.5 Write unit tests for calibration router
...
- [x] 3. Checkpoint — Calibration service complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement Explainability Service and router (Python)
  - [x] 4.1 Implement `ml_service/app/services/explainability.py`
  ...
  - [x] 4.2 Write property tests for Explainability Service
  ...
  - [x] 4.3 Implement `ml_service/app/routers/explainability.py`
  ...
  - [x] 4.4 Register explainability router in `ml_service/app/main.py`
    - Import and include explainability router
    - _Requirements: 4.1_

  - [x] 4.5 Write unit tests for explainability router
    - Test GET endpoint with existing data, missing data (404), invalid asset (400)
    - Create `ml_service/tests/test_explainability.py`
    - _Requirements: 4.1, 4.2, 4.3, 4.4_

- [x] 5. Implement Drift Detector and router (Python)
  - [x] 5.1 Implement `ml_service/app/services/drift_detector.py`
  ...
  - [x] 5.2 Write property tests for Drift Detector
  ...
  - [x] 5.3 Implement `ml_service/app/routers/drift.py`
  ...
  - [x] 5.4 Register drift router in `ml_service/app/main.py`
    - Import and include drift router
    - _Requirements: 7.4_

  - [x] 5.5 Write unit tests for drift detector and router
...
- [x] 6. Checkpoint — ML service complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Implement Event Context Service (TypeScript)
  - [x] 7.1 Implement `src/services/pipeline/event-context-service.ts`
  ...
  - [x] 7.2 Write property tests for Event Context Service
  ...
  - [x] 7.3 Write unit tests for Event Context Service
...
- [x] 8. Implement DiagnosticsCollector extension and batch integration (TypeScript)
  - [x] 8.1 Add `recordLearningPipeline()` method to `DiagnosticsCollector`
  ...
  - [x] 8.2 Write property tests for Learning Pipeline Diagnostics
  ...
  - [x] 8.3 Write unit tests for DiagnosticsCollector learning pipeline extension
...
- [x] 9. Checkpoint — TypeScript services complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Dashboard Continuous Learning card
  - [x] 10.1 Implement `renderContinuousLearningCard()` in `dashboard/index.html`
  ...
  - [x] 10.2 Write property tests for dashboard Continuous Learning card
  ...
  - [x] 10.3 Write unit tests for dashboard Continuous Learning card
...
- [x] 11. Cloud Scheduler drift check job configuration
  - [x] 11.1 Add weekly drift check job to `deploy/cloud-scheduler.yaml`
...
- [x] 12. Integration wiring — connect all components in batch pipeline
  - [x] 12.1 Wire Event Context Service and calibration calls into batch pipeline
  ...
  - [x] 12.2 Write integration tests for the complete learning pipeline flow
