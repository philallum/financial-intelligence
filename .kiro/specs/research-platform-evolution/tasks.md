...
- [x] 1. Set up Research namespace and database migrations
  - [x] 1.1 Create Research namespace directory structure and barrel files
  ...
  - [x] 1.2 Create database migration for research_forecasts table (Phase 1)
  ...
  - [x] 1.3 Create database migration for research_evaluations table (Phase 2)
  ...
  - [x] 1.4 Create database migration for research_similarity_archive table (Phase 3)
  ...
  - [x] 1.5 Create database migration for fingerprint_topology table (Phase 6)
  ...
  - [x] 1.6 Create database migration for research_experiments table (Phase 5)
  ...
  - [x] 1.7 Write migration tests for all new tables
...
- [x] 2. Implement Phase 1 — Prediction Persistence (Research Archive Writer)
  - [x] 2.1 Implement ResearchArchiveWriter in `src/research/persistence/research-archive-writer.ts`
  ...
  - [x] 2.2 Wire Research Archive Writer into batch pipeline
  ...
  - [x] 2.3 Write property test for Record Provenance Completeness
  ...
  - [x] 2.4 Write property test for Duplicate Rejection Idempotence
  ...
  - [x] 2.5 Write unit tests for Research Archive Writer
...
- [-] 4. Implement Phase 2 — Evaluation Engine
  - [x] 4.1 Implement Evaluation Engine in `src/research/evaluation/evaluation-engine.ts`
  ...
  - [x] 4.2 Implement Calibration Bucket Assignment in `src/research/evaluation/calibration.ts`
  ...
  - [x] 4.3 Wire Evaluation Engine into batch pipeline as post-pipeline stage
  ...
  - [x] 4.4 Write property test for Evaluation Metrics Correctness
  ...
  - [x] 4.5 Write property test for Calibration Bucket Assignment
  ...
  - [x] 4.6 Write property test for Calibration Accuracy Computation
  ...
  - [x] 4.7 Write unit tests for Evaluation Engine
...
- [x] 5. Implement Phase 3 — Similarity Archive
  - [x] 5.1 Implement Similarity Archiver in `src/research/archival/similarity-archiver.ts`
  ...
  - [x] 5.2 Wire Similarity Archiver into batch pipeline
  ...
  - [x] 5.3 Write unit tests for Similarity Archiver
...
- [x] 7. Implement Phase 5 — Platform Observability (Trace Wiring)
  - [x] 7.1 Wire trace emitter into all batch stage handlers
  ...
  - [x] 7.2 Write property test for Trace Schema Completeness
  ...
  - [x] 7.3 Write property test for Trace Failure Isolation
...
- [x] 8. Implement Phase 4 — Confidence Calibration (Evidence-Based)
  - [x] 8.1 Implement Confidence Engine v2 in `src/engines/confidence-engine-v2.ts`
  ...
  - [x] 8.2 Write property test for Confidence Output Bounds
  ...
  - [x] 8.3 Write unit tests for Confidence Engine v2
...
- [x] 9. Implement Phase 6 — Support & Resistance Topology Engine
  - [x] 9.1 Implement Topology Engine in `src/engines/topology-engine.ts`
  ...
  - [x] 9.2 Wire Topology Engine into batch pipeline
  ...
  - [x] 9.3 Write property test for Topology Output Invariants
  ...
  - [x] 9.4 Write unit tests for Topology Engine
...
- [x] 11. Implement Phase 7 — Rich Market Context (Extended Fingerprint Features)
  - [x] 11.1 Implement extended feature computation in `src/engines/fingerprint-engine.ts`
  ...
  - [x] 11.2 Write property test for Extended Feature Bounds and Defaults
  ...
  - [x] 11.3 Write property test for Feature Enablement via Config
  ...
  - [x] 11.4 Write unit tests for extended feature computation
...
- [x] 12. Implement Phase 8 — Regime Classification v2
  - [x] 12.1 Implement Regime Engine v2 in `src/engines/regime-engine-v2.ts`
  ...
  - [x] 12.2 Wire Regime Engine v2 into batch pipeline
  ...
  - [x] 12.3 Write property test for Regime v2 Output Structure
  ...
  - [x] 12.4 Write unit tests for Regime Engine v2
...
- [x] 13. Implement Experimentation Engine (Phase 5)
  - [x] 13.1 Implement Experiment Runner in `src/research/experimentation/experiment-runner.ts`
  ...
  - [x] 13.2 Write property test for Experiment Production Isolation
  ...
  - [x] 13.3 Write unit tests for Experiment Runner
...
- [x] 14. Implement cross-cutting correctness properties and remaining tests
  - [x] 14.1 Write property test for Universal Engine Determinism
  ...
  - [x] 14.2 Write property test for Empirical Distribution Purity
  ...
  - [x] 14.3 Write property test for OHLC Validation Invariant
  ...
  - [x] 14.4 Write property test for Deterministic Tie-Breaking
  ...
  - [x] 14.5 Write property test for Point-in-Time Correctness
  ...
  - [x] 14.6 Write property test for Gap Detection Completeness
...
- [-] 15. Final integration, wiring, and documentation
  - [x] 15.1 Implement integration between all phases and the batch orchestrator
  ...
  - [x] 15.2 Update CURRENT-STATE.md with all new tables, engines, and capabilities
  ...
  - [x] 15.3 Write integration tests for research archive lifecycle
