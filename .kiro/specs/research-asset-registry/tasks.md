...
- [x] 1. Create registry module with types, validation, and seed entry
  - [x] 1.1 Create `src/config/research-assets.ts` with types and enums
  ...
  - [x] 1.2 Add the RESEARCH_ASSETS array with EURUSD seed entry and validation
...
- [x] 2. Implement query utilities
  - [x] 2.1 Implement `getProcessableAssets()` and `getActiveSymbols()`
  ...
  - [x] 2.2 Implement `getAssetById()` and `getAssetBySymbol()`
  ...
  - [x] 2.3 Implement `getOpenApiAssetEnum()` and `getAssetsByClass()`
...
- [x] 3. Property-based tests for registry module
  - [x] 3.1 Write property test for Registry Schema Invariant
  ...
  - [x] 3.2 Write property test for Registry Uniqueness Invariant
  ...
  - [x] 3.3 Write property test for Processable Assets Filter and Sort
  ...
  - [x] 3.4 Write property test for Active Symbols Filter
  ...
  - [x] 3.5 Write property test for Case-Insensitive Lookup
  ...
  - [x] 3.6 Write property test for OpenAPI Enum Generation
  ...
  - [x] 3.7 Write property test for Class-Based Filtering
  ...
  - [x] 3.8 Write property test for Price Precision Formatting
...
- [x] 4. Checkpoint - Ensure registry module and property tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Batch pipeline integration
  - [x] 5.1 Refactor `src/batch-entry.ts` to use registry
  ...
  - [x] 5.2 Update `BatchOrchestrator` to accept and use `engineParticipation`
  ...
  - [x] 5.3 Write unit tests for batch pipeline registry integration
...
- [x] 6. API route integration
  - [x] 6.1 Refactor `src/api/routes/forecast.ts` to use registry
  ...
  - [x] 6.2 Refactor `src/api/routes/similarity.ts` to use registry
  ...
  - [x] 6.3 Refactor `src/api/routes/state.ts` to use registry
    - Remove any hardcoded asset validation
    - Import `getActiveSymbols` from registry
    - Validate asset parameter against active symbols from registry
    - Return HTTP 400 with `asset_not_supported` and active symbol list for invalid assets
  ...
  - [x] 6.4 Write unit tests for API route registry integration
...
- [x] 7. OpenAPI generator refactor
  - [x] 7.1 Refactor `scripts/generate-openapi.ts` to use registry
  ...
  - [x] 7.2 Write unit test for OpenAPI generator registry integration
